...
class SlideBackManager  constructor(activity: Activity) {
     ...
     * 完全透明
     */
    fun withTransparent(isTransparent:Boolean) : SlideBackManager{
    ...
    fun register() {
        if (isAllowEdgeLeft) {
            ...
            slideBackIconViewLeft?.withTransparent(isTransparent)
        }
        if (isAllowEdgeRight) {
            ...
            slideBackIconViewRight?.withTransparent(isTransparent)
        }
