...
object StatusBarUtil {
    ...
    fun FragmentActivity.registerActivity(dark: Boolean) {
        if (GetSystemUtils.getSystem() == GetSystemUtils.meizu) {
            setMeizuStatusBarDarkIcon(this, dark)
        } else if (GetSystemUtils.getSystem() == GetSystemUtils.xiaomi) {
            setMiuiStatusBarDarkMode(this, dark)
        } else if (GetSystemUtils.getSystem() == GetSystemUtils.oppo) {
            setOPPOStatusTextColor(this, dark)
        } else {
            android6StatusBarDarkMode(this, dark)
        }
    }
