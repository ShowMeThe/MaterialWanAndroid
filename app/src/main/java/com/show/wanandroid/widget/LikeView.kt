...
class LikeView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private fun initType(context: Context, attrs: AttributeSet?) {
        ...
        val color = arrary.getColor(R.styleable.LikeView_colors,Color.parseColor("#DC143C"))
        colors = arrayOf(color)
        val likeColor = arrary.getColor(R.styleable.LikeView_likeColor,Color.parseColor("#DC143C"))
        val unLikeColor = arrary.getColor(R.styleable.LikeView_unLikeColor,Color.parseColor("#E6E6FA"))
